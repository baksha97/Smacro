...
import Foundation
public extension SmacroKit.Glob.Behavior {
  static let globBehaviorGradle: Self = .init(
  ...
  static let globBehaviorBashV3: Self = .init(
  ...
  static let globBehaviorBashV4: Self = .init(
...
public extension SmacroKit {
  ...
  class Glob: Collection {
    ...
    public static var defaultBehavior: Glob.Behavior = .globBehaviorBashV4
